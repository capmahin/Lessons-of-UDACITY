...
function createStairs() {
	...
	// how much each step piece is moved up and forword
	var riserHight = verticalStepHeight + stepThickness;
	...
	for(stepPair = 0; stepPair < 6; stepPair++){
		...
		stepMesh.position.y = verticalStepHeight/2 + stepPair*riserHight;
		...
		stepMesh.position.y = stepThickness/2 + verticalStepHeight+ stepPair*riserHight;
		// push step forword by half the depth , minus half the vertical step's thickness
